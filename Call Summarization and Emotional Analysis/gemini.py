...
#         responsesFile = f'Gemini Responses/response{responseNumber:02d}.txt'
        
#         with open(transcriptionFile, 'r') as file:
#             transcription = file.read()
        
#         response = get_gemini_response(transcription, i, j)
        
#         with open(responsesFile, 'w') as file:
#             file.write(response)
        
        
#         print(f'Response saved to {responsesFile} for response number {responseNumber}')
